      ...
      <div className="container social">
        <div className="row">
          <div className="col-md text-center" data-aos="fade-up-left">
            ...
            <p className="pt-3">
              <a
                href="https://github.com/mcsarmend"
                target="_blank"
                rel="noopener noreferrer"
              >
                github.com/mcsarmend
              </a>
            </p>
          </div>
          <div className="col-md text-center" data-aos="fade-up">
            ...
            <p className="pt-3">
              <a
                href="https://www.linkedin.com/in/clemente-armando-zarraga-cruz/"
                target="_blank"
                rel="noopener noreferrer"
              >
                linkedin.com/in/clemente-armando-zarraga-cruz
              </a>
            </p>
          </div>
          <div className="col-md text-center" data-aos="fade-up-right">
            ...
            <p className="pt-3">
              <a
                href="mailto:mcsarmend@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
              >
                mcsarmend@gmail.com
